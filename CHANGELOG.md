...
- [#52](https://github.com/OpusCapita/oauth2_proxy/pull/52) Logging Improvements (@MisterWil)
...
- [#92](https://github.com/OpusCapita/oauth2_proxy/pull/92) Merge websocket proxy feature from openshift/oauth-proxy (@butzist)
